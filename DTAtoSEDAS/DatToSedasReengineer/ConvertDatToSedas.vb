Public Class ConvertDATtoSEDAS
	...
	Public Function ConvertFile() As Boolean
		...
		Try
			...
			Using Dim streamReader As StreamReader = New StreamReader(Me._SourcePath)
	...
	Private Function WriteSedasData() As Boolean
		...
		Try
			...
			End If
			Using Dim streamWriter As StreamWriter = New StreamWriter(Me._DestinationPath, False)
					Try
